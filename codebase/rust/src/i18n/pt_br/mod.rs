...
impl ILanguage for BrazilianPortuguese {
    fn get_territory_dictionary(&self) -> I18nDefaultDictionary<'static> {
        HashMap::from([
            ...
            (
                "romance_speaking_territory",
                "Território de Língua Românica",
            ),
            ...
            (
                "north_pacific_civilization",
                "Civilização do Pacífico Norte",
            ),
            ("aztecas", "Astecas"),
            ("mayas", "Maias"),
            ...
            (
                ...
                "Planalto do Centrol do Sub-Continente",
            ),
    ...
    fn get_sub_continents(&self) -> I18nSubContinent<'static> {
        HashMap::from([
            ...
            (
                &SubContinent::EuropeRelatedAsia,
                "Asia Relacionada à Europa",
            ),
        ])
    }
