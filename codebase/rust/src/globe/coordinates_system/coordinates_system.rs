...
impl CoordinatesSystem {
    ...
    fn passes_by_other_territories(
        ...
        base_geodesic_trajectory
            ...
            .find(|trajectory_point| {
                ...
                let passes_by_other_territories = surface_point
                    .surface_point_metadata
                    .territory_id
                    .as_ref()
                    .is_some_and(|territory_id| territory_id != within_the_territory_id);
    ...
    pub fn get_in_the_frontiers_trajectory(
        ...
        let in_the_frontiers_trajectory = in_the_frontiers_coordinates
            .iter()
            .map(|coordinate| {
        ...
        for neighbor in neighbors.iter() {
            ...
            let in_other_territory = neighbor_metadata
                ...
                .is_some_and(|neighbor_territory_id| {
                    neighbor_territory_id.to::<String>() != *within_the_territory_id
                });
            ...
            if in_other_territory {
                let mut heat_map_dictionary = troop
                    .get_meta("heat_map_trajectory_helper")
                    .to::<Dictionary>();
                heat_map_dictionary.set(heat_map_dictionary_key, i32::MAX);
                continue;
            }
            ...
            let mut heat_map_dictionary = troop
                .get_meta("heat_map_trajectory_helper")
                .to::<Dictionary>();
            heat_map_dictionary.set(heat_map_dictionary_key, neighbor_distance);
    ...
    fn get_neighbors(current_coordinate: Coordinates) -> [Coordinates; 8] {
        const BUFFER: i16 = 1;
